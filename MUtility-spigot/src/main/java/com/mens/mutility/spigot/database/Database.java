...
public class Database {
    ...
    private void createTablesIfNotExists() throws SQLException {
        ...
        stm.execute();
        stm = con.prepareStatement("CREATE TABLE IF NOT EXISTS " + tables.getInventoryTeleportTable() + "(id INTEGER PRIMARY KEY NOT NULL AUTO_INCREMENT, user_id int(8) NOT NULL, inventory longtext NOT NULL, fromX double NOT NULL, fromY double NOT NULL, fromZ double NOT NULL, fromWorld varchar(255) NOT NULL, fromServer varchar(255) NOT NULL, toX double, toY double, toZ double, toWorld varchar(255), toServer varchar(255), created_date datetime, completed int(1), FOREIGN KEY (user_id) REFERENCES web_users(id))");
        stm.execute();
